...
def iqindlateral(df, j1, pos):
    ...
    ax0 = plt.subplot2grid(shape=(sh, 7), loc=(0, 0), colspan=4, rowspan=6)
    ax1 = plt.subplot2grid(shape=(sh, 7), loc=(6, 0), colspan=4, rowspan=9)
    ax2 = plt.subplot2grid(shape=(sh, 7), loc=(15, 0), colspan=4, rowspan=8)
    ax3 = plt.subplot2grid(shape=(sh, 7), loc=(18, 0), colspan=4, rowspan=9)
    ax4 = plt.subplot2grid(shape=(sh, 7), loc=(21, 0), colspan=4, rowspan=7)
    ax5 = plt.subplot2grid(shape=(sh, 7), loc=(30, 0), colspan=4, rowspan=9)
    ax6 = plt.subplot2grid(shape=(sh, 7), loc=(2, 4), colspan=4, rowspan=1)
    ax7 = plt.subplot2grid(shape=(sh, 7), loc=(3, 4), colspan=3, rowspan=12)
    ax8 = plt.subplot2grid(shape=(sh, 7), loc=(18, 4), colspan=4, rowspan=1)
    ax9 = plt.subplot2grid(shape=(sh, 7), loc=(19, 4), colspan=3, rowspan=12)
    fig.subplots_adjust(left=0.1,
                        bottom=0.1,
                        right=0.9,
